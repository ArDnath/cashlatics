    ...
    <div className="space-y-8">
      ...
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
        <Link href="/account/create">
          <div className="group relative overflow-hidden rounded-2xl p-px h-full cursor-pointer">
            <div className="absolute inset-0 bg-linear-to-br from-slate-200 to-slate-100 dark:from-neutral-800 dark:to-neutral-900 opacity-100 transition-opacity" />
